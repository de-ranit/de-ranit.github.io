...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-the-first-paper-of-my-phd-on-addressing-challenges-in-simulating-inter-annual-variability-of-gross-primary-production-is-finally-published",
          title: 'The first paper of my PhD on “Addressing Challenges in Simulating Inter-annual Variability...',
          description: "",
          section: "News",},{id: "news-i-contributed-a-talk-on-improving-simulation-of-iav-of-gpp-with-temporal-variation-of-hydrological-parameters-at-egu-mary-anning-conference",
          title: 'I contributed a talk on improving simulation of IAV of GPP with temporal...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%72%64%65@%62%67%63-%6A%65%6E%61.%6D%70%67.%64%65", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/de-ranit", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ranitde", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-4362-0106", "_blank");
        },
      },{
        id: 'social-work',
        title: 'Work',
        section: 'Socials',
        handler: () => {
          window.open("https://www.bgc-jena.mpg.de/person/rde/2206", "_blank");
        },
      },{
      id: 'light-theme',
